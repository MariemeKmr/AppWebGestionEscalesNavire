...
public class BonPilotageService {
    ...
    public void ajouterBonPilotage(BonPilotage bon) {
        try { dao.ajouterBonPilotage(bon); }
        catch (SQLException e) { throw new RuntimeException(e); }
    }
    public BonPilotage getBonPilotageParId(int id) {
        try { return dao.getBonPilotageParId(id); }
        catch (SQLException e) { throw new RuntimeException(e); }
    }
    public List<BonPilotage> getTousLesBonsPilotage() {
        try { return dao.getTousLesBons(); }
        catch (SQLException e) { throw new RuntimeException(e); }
    }
    public void modifierBonPilotage(BonPilotage bon) {
        try { dao.modifierBon(bon); }
        catch (SQLException e) { throw new RuntimeException(e); }
    }
    public void supprimerBonPilotage(int id) {
        try { dao.supprimerBon(id); }
        catch (SQLException e) { throw new RuntimeException(e); }
    }
    public List<BonPilotage> rechercher(String navire, String consignataire) {
        try { return dao.rechercher(navire, consignataire); }
        catch (SQLException e) { throw new RuntimeException(e); }
    }
}