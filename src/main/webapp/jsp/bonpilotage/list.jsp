...
<head>
    ...
    <script>
        // Recherche dynamique simple côté client (filtre le tableau)
        function filterBons() {
            ...
            <table>
                ...
                <c:forEach var="bon" items="${bons}">
                    <tr>
                        ...
                        <td>
                            <c:out value="${bon.monEscale.numeroEscale}"/>
                        </td>
                        <td>
                            <c:choose>
                        ...
                        <td>
                            <c:out value="${bon.dateDeBon}" />
                        </td>
                        <td>
                            <c:out value="${bon.dateFinBon}" />
                        </td>
                        <td>${bon.posteAQuai}</td>
                        <td>
							<span class="fw-bold"><fmt:formatNumber value="${bon.montEscale}" type="number" groupingUsed="true"/> F CFA</span>                        </td>
                        <td class="actions">
                            <a href="${pageContext.request.contextPath}/bonpilotage/view?id=${bon.idMouvement}" title="Voir">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="${pageContext.request.contextPath}/bonpilotage/edit?id=${bon.idMouvement}" title="Modifier">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="${pageContext.request.contextPath}/bonpilotage/delete?id=${bon.idMouvement}" title="Supprimer" onclick="return confirm('Supprimer ce bon ?');">
